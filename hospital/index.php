...
<head>
    ...
    <title> HMS To Hakim Gizaw General Hospital </title>
            ...
            <div class="carousel-inner">
                <div class="carousel-item ">
                    ...
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        <h5 class="animated bounceInDown">HMS To Hakim Gizaw General Hospital</h5>
    ...
    <section id="services" class="key-features department">
        <div class="container">
            <div class="inner-title">
                ...
                <h2>Key Features</h2>
                <p>Take a look at some of key features of the system</p>
            </div>
    ...
    <section id="about_us" class="about-us">
        <div class="row no-margin">
            ...
            <div class="col-sm-6 abut-yoiu">
                <h3>About HMS In Hakim Gizaw General Hospital</h3>
<?php
...
?>
                        ...
                        <Address>Address: Debre birhan <br>
                        Hakim Gizaw General Hospital
                        </Address>
                        Phone: +251965970482/+251918620710<br>
                        Email: ebrahimhussen117@gmail.com<br>
    ...
    <div class="copy">
         ...
         Hospital Management System <br>
           To Hakim Gizaw General Hospital
